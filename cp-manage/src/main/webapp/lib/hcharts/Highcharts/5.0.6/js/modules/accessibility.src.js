    ...
    (function(H) {
        ...
        H.Series.prototype.buildSeriesInfoString = function() {
            ...
            return (this.name ? this.name + ', ' : '') +
                (this.chart.types.length === 1 ? typeInfo[0] : 'series') + ' ' + (this.index1 + 1) + ' of ' + (this.chart.series.length) +
        ...
        H.Point.prototype.buildPointInfoString = function() {
            ...
            return (this.index1 + 1) + '. ' + infoString + '.' + (this.description ? ' ' + this.description : '');
        };
        ...
        H.Chart.prototype.highlightAdjacentPoint = function(next) {
            var series = this.series,
                ...
                curPointIndex = curPoint && curPoint.index1 || 0,
                newSeries,
                newPoint;
            ...
            newSeries = series[curPoint.series.index1 + (next ? 1 : -1)];
                    ...
                    [
                        ...
                        function(keyCode) {
                            ...
                            if (chart.highlightedPoint) {
                                newSeries = chart.series[chart.highlightedPoint.series.index1 + (keyCode === 38 ? -1 : 1)]; // Find prev/next series
        ...
        H.Chart.prototype.callbacks.push(function(chart) {
            ...
            var titleElement = doc.createElementNS('http://www.w3.org/2000/svg', 'title'),
                ...
                titleId = 'highcharts-title-' + chart.index1,
                tableId = 'highcharts-data-table-' + chart.index1,
